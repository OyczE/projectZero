#!/usr/bin/env python3
"""
Build ESP32P4 firmware inside the official ESP-IDF docker image without
brudzenia drzewa roboczego. Tworzy tymczasową kopię repo, buduje w kontenerze,
po czym kopiuje artefakty do tools/docker_bin_output.

Usage:
    python tools/build_bin_docker.py [--image espressif/idf:v5.4.1]
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--image",
        default="espressif/idf:v5.4.1",
        help="Docker image to use (default: espressif/idf:v5.4.1)",
    )
...
def main() -> int:
    ...
    tmpdir = Path(tempfile.mkdtemp(prefix="m5monsterc5-tab5-build-"))
    ...
    src_bins = workspace / "binaries-esp32p4"
