#!/usr/bin/env python3
"""
Build JanOS firmware inside the official ESP-IDF docker image without
brudzenia drzewa roboczego. Tworzy tymczasową kopię repo, buduje w kontenerze,
po czym kopiuje artefakty do JanOS/tools/docker_bin_output.

Usage:
    python JanOS/tools/build_bin_docker.py [--image espressif/idf:v6.0-beta1]
"""
...
def main() -> int:
    ...
    try:
        shutil.copytree(
            ...
            ignore=shutil.ignore_patterns(
                ...
                "__pycache__",
                "JanOS/build",
                "JanOS/managed_components",
                "JanOS/binaries-esp32c5",
            ),
        )
    ...
    src_bins = workspace / "JanOS" / "binaries-esp32c5"
    dest_bins = repo_root / "JanOS" / "tools" / "docker_bin_output"
